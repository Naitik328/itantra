"""
Interactive test — type Telugu text yourself, hear it spoken.

Run this from inside the telegufinal folder:
    python try_it_yourself.py

Type any Telugu sentence and press Enter. It saves each one as a numbered
...
if not config.validate():
    raise ValueError("Config invalid — make sure you're running this from inside the telegufinal folder")
...
print("Ready. Type Telugu text and press Enter (type 'exit' to quit).\n")
