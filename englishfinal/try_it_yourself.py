...
Run this from inside the englishfinal folder:
    python try_it_yourself.py

Type any English sentence and press Enter. It saves each one as a numbered
...
if not config.validate():
    raise ValueError("Config invalid — make sure you're running this from inside the englishfinal folder")
